...
var _videoGalleryEmbed = require("./components/VideoGalleryEmbed");
var _videoGalleryEmbedDefault = parcelHelpers.interopDefault(_videoGalleryEmbed);
var _readMoreJs = require("./components/ReadMore.js");
var _faq = require("./components/FAQ");
var _movingBanner = require("./components/MovingBanner");
...
class FinanzFit {
    ...
    init() {
        ...
        if (galleryContainer) galleryContainer.innerHTML = (0, _videoGalleryEmbedDefault.default);
        // Initialisiere FAQ
        (0, _faq.initFAQ)();
        // Initialisiere Moving Banner
        (0, _movingBanner.initMovingBanner)();
        // Initialisiere Video Embed
        (0, _videoEmbed.initVideoEmbed)();
    }
}
// Initialisierung
new FinanzFit();

},{"@xatom/core":"8w4K8","./routes":"fnEL6","./animations":"jTkOJ","./components/VideoGalleryEmbed":"jaQKT","./components/ReadMore.js":"8UPYe","./components/FAQ":"5Q9gu","./components/MovingBanner":"9Pvvp","./components/VideoEmbed":"7FQD0","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"8w4K8":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"jTkOJ":[function(require,module,exports,__globalThis) {
...
},{"gsap":"33IqQ","gsap/ScrollTrigger":"5ubnS"}],"33IqQ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"jaQKT":[function(require,module,exports,__globalThis) {
...
`;
exports.default = videoGalleryEmbed;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"8UPYe":[function(require,module,exports,__globalThis) {
document.addEventListener('DOMContentLoaded', function() {
        ...
        if (fullText.length > maxLength) {
            ...
            readMoreButton.addEventListener('click', (event)=>{
                ...
                if (wrapper.classList.contains('expanded')) {
                    ...
                    buttonText.textContent = "schlie\xdfen";
...
},{}],"5Q9gu":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"9Pvvp":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initMovingBanner", ()=>initMovingBanner);
var _gsap = require("gsap");
function initMovingBanner() {
    const firstRow = document.querySelector(".move-usp.first-row-move");
    const secondRow = document.querySelector(".move-usp.second-row-move");
    ...
    (0, _gsap.gsap).set(firstRow, {
        x: 0
    });
    (0, _gsap.gsap).set(secondRow, {
        x: 0
    });
    ...
    (0, _gsap.gsap).killTweensOf(firstRow);
    (0, _gsap.gsap).killTweensOf(secondRow);
    ...
    const secondRowTween = (0, _gsap.gsap).to(secondRow, {
        x: 0,
        duration: 100,
        ease: "none",
        repeat: -1
...
},{"gsap":"33IqQ","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"7FQD0":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initVideoEmbed", ()=>initVideoEmbed);
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        document.body.addEventListener("click", function(event) {
            ...
            if (playButton) {
                ...
                if (wrapper.querySelector("iframe")) return; // An iframe already exists, do nothing
                ...
                var videoOrientation = wrapper.getAttribute("data-video-orientation");
                if (videoOrientation === "Vertikal") wrapper.style.paddingTop = "56.25%"; // 16:9 für horizontal
                else wrapper.style.paddingTop = "177.78%"; // 9:16 für vertikal
            }
        });
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}]},["jeTtx"], "jeTtx", "parcelRequire8e80", {})
